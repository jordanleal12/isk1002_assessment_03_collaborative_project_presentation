...
![Daily stand-up for 22/10/25](images/daily-stand-up-22.10.png)
![Daily stand-up for 29/10/25](images/daily-stand-up-29.10.png)
![Daily stand-up for 30/10/25](images/daily-stand-up-30.10.png)
...
![Pull Request #11](images/pull-request-11.png)
![Pull Request #22](images/pull-request-22.png)
![Pull Request #27](images/pull-request-27.png)
![Pull Request #27 Feedback/Approval](images/pull-request-27-feedback-approval.png)
...
- Following the coverage of learning about GitHub Actions and how we can use this to automate workflows, Joss created a YAML file to automatically run checks and tests on our environment variables and secret keys to ensure that secret keys existed and were configured on pushes.
  ![Test Secrets YAML](images/test-secrets-yml.png)
  ![Test Secrets Workflow](images/test-secrets-workflow.png)
